# Traceability: device-class-registry/1

One row per requirement ID `contracts/device-class-registry.md` defines. Format: `conformance/traceability/README.md`.
...
| REG-066 | `contracts/device-class-registry.md#the-media-player-class` | `roku-media-player` | covered |
