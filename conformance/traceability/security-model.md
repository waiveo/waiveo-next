...
| SEC-031 | `contracts/security-model.md#grants` | - | TBD-wave1 |
| SEC-032 | `contracts/security-model.md#grants` | - | TBD-wave1 |
| SEC-033 | `contracts/security-model.md#grants` | - | TBD-wave1 |
| SEC-034 | `contracts/security-model.md#grants` | - | TBD-wave1 |
| SEC-035 | `contracts/security-model.md#grants` | - | TBD-wave1 |
...
| SEC-050 | `contracts/security-model.md#credential-reset-grants` | - | TBD-wave1 |
| SEC-051 | `contracts/security-model.md#credential-reset-grants` | - | TBD-wave1 |
| SEC-052 | `contracts/security-model.md#credential-reset-grants` | - | TBD-wave1 |
| SEC-053 | `contracts/security-model.md#credential-reset-grants` | - | TBD-wave1 |
...
| SEC-066 | `contracts/security-model.md#app-tier-clock-trust` | - | TBD-wave1 |
| SEC-067 | `contracts/security-model.md#app-tier-clock-trust` | - | TBD-wave1 |
| SEC-068 | `contracts/security-model.md#app-tier-clock-trust` | - | TBD-wave1 |
...
| SEC-072 | `contracts/security-model.md#the-console-binding` | - | TBD-wave1 |
| SEC-073 | `contracts/security-model.md#the-console-binding` | - | TBD-wave1 |
| SEC-074 | `contracts/security-model.md#the-console-binding` | - | TBD-wave1 |
| SEC-075 | `contracts/security-model.md#the-console-binding` | - | TBD-wave1 |
| SEC-076 | `contracts/security-model.md#the-console-binding` | - | TBD-wave1 |
...
| SEC-120 | `contracts/security-model.md#first-boot-claim-window-and-factory-reset` | - | TBD-wave1 |
| SEC-121 | `contracts/security-model.md#first-boot-claim-window-and-factory-reset` | - | TBD-wave1 |
