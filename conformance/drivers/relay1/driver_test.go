...
var expectedDriven = []string{
	...
	"REL-051-valid-ahead-generation-full-snapshot",
	...
	"REL-090a-valid-entry-without-usable-trace-id-still-delivered",
	...
	"REL-116-valid-engine-state-zero-counts-and-replace",
