...
| `entity-picker` | input | no | `labelMsg` (required, UIS-075), `modes?` (non-empty subset of `["entity","selector","deviceClass"]`, default all three) | object — `rules/1` EntityRef shape (UIS-073) | `change?` |
      ...
      { "when": "not", "render": { "type": "fragment", "bind": "item.not", "props": { "ref": "condition-editor" } } },
      {
        ...
        "render": {
          ...
          "props": {
            ...
            "cases": [
              { "when": "state", "render": { "type": "entity-picker", "bind": "item.entity_id", "props": { "labelMsg": "msg:automations.detail.conditionEntityLabel" } } },
